...
<div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Login Form -->
            <form action="{{ route('auth.verifyRegisterSuper') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" id="super_user" name="super_user" class="form-control" placeholder="Masukkan User" required>
                @error('super_user')
            ...
            <div class="d-flex justify-content-center mt-3">
                <div class="d-flex justify-content-between">
                    <small> Already have an account? 
                        <a class="" href="/login/super" class="text-decoration-none">Login now</a>
                    </small>
                </div>
            </div>
        </div>
