            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                ...
                <form action="{{ route('auth.verify') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="nik" name="nik" class="form-control" placeholder="Masukkan NIK" required value="{{ old('nik') }}">
                        @error('nik')
                    ...
                    <div class="form-check mb-3 d-flex justify-content-between mt-3">
                        ...
                        <div>
                            <a href="/password/reset" class="text-decoration-none text-secondary">Forgot your password?</a>
                        </div>
                    </div>
