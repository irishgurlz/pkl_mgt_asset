...
<div class="container" data-aos="fade-up">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="card shadow mb-4">
            ...
            <form id="form-edit-sub" action="{{ route('sub-kategori.update', $subKategori->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-sm-9">
                    <select name="kategori" id="kategori" class="form-select" required>
                        ...
                        @forelse ($kategori as $item)
                            <option value="{{ $item->id }}" 
                                {{ $item->id == $subKategori->id_kategori ? 'selected' : '' }}>
                                {{ $item->nama }}
                            </option>
                        @empty
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input 
                                ...
                                name="nama" 
                                class="form-control" 
                                value="{{ old('nama', $subKategori->nama) }}" 
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" id="submit-btn" class="btn btn-primary" style="width: 120px;">Edit</button>
                    </div>
                </form>
            </div>
        </div>
