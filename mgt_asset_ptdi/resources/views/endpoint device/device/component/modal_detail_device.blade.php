    ...
    <div class="modal-dialog modal-xl" style="max-width: 80%;">
        <div class="modal-content" style="background-color: #ffffff; border-radius: 15px;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Perangkat</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-7" id="modal-kondisi"></div>
                            </div>
                            <div class="row mb-3">
...
<script>
    ...
    myModal.addEventListener('show.bs.modal', function (event) {
        ...
        if (umurDate) {
            if (isNaN(Date.parse(umurDate))) {
                document.getElementById('modal-umur').textContent = umurDate; 
            } else {
                var today = new Date();
        ...
        document.getElementById('modal-vga-capacity').textContent = button.getAttribute('data-vga-capacity') + " GB";
        ...
        document.getElementById('modal-kondisi').textContent = button.getAttribute('data-kondisi');
