        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="table-responsive" style="overflow:hidden">
                    <form action="{{ route('device.update', $device->id) }}" id="form-edit-device" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="hidden" id="id_tipe" name="id_tipe" value="{{ old('id_tipe', $device->id_tipe ?? '') }}">
                                            @error('id_tipe')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" name="umur" id="umur" placeholder="Masukkan Tanggal" class="form-control" value="{{old('umur', $device->umur)}}"required>
                                    ...
                                    <div class="row">
                                        <div class=" col col-6">
                                            ...
                                            <div class="dropdown mb-3">
                                                ...
                                                <button class="btn text-start dropdown-toggle" type="button" id="dropdownProcessor" data-bs-toggle="dropdown" aria-expanded="false">
                                                    {{ old('processor') ? $processor->where('id', old('processor'))->first()->nama ?? '-- Pilih Processor --' : 
                                                    ($device->processorType ? $device->processorType->nama : '-- Pilih Processor --') }}
                                                </button>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownProcessor">
                                                    ...
                                                    <div id="processor-list">
                                                        @forelse ($processor as $item)
                                                            <li><a class="dropdown-item" href="#" name="processor" data-value="{{ $item->id }}">{{ $item->nama }}</a></li>
                                                        @empty
                                            ...
                                            <input type="hidden" id="selected-processor" name="processor" value="{{ old('processor', $device->processor) }}">
                                            ...
                                            <div class="dropdown mb-3">
                                                ...
                                                <button class="btn text-start dropdown-toggle" type="button" id="dropdownStorage" data-bs-toggle="dropdown" aria-expanded="false">
                                                    {{ old('storage_type') ? $storageType->where('id', old('storage_type'))->first()->nama ?? '-- Pilih Storage Type --' : 
                                                    ($device->storageType ? $device->storageType->nama : '-- Pilih Storage Type --') }}
                                                </button>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownStorage">
                                                    ...
                                                    <div id="storage-list">
                                                        @forelse ($storageType as $item)
                                                            <li><a class="dropdown-item" href="#" name="storage_type" data-value="{{ $item->id }}">{{ $item->nama }}</a></li>
                                                        @empty
                                                            <li class="no-data"><a class="dropdown-item" href="#">Tidak Ada Data</a></li>
                                                        @endforelse
                                                    </div>
                                            ...
                                            <input type="hidden" id="selected-storage" name="storage_type" value="{{ old('storage_type', $device->storage_type) }}">

                                            <!-- Memory Type -->
                                            <div class="dropdown mb-3">
                                                <label for="memory_type" class="form-label">Memory Type</label>
                                                <button class="btn text-start dropdown-toggle" type="button" id="dropdownStorage" data-bs-toggle="dropdown" aria-expanded="false">
                                                    {{ old('memory_type') ? $memoryType->where('id', old('memory_type'))->first()->nama ?? '-- Pilih Memory Type --' : 
                                                    ($device->memoryType ? $device->memoryType->nama : '-- Pilih Memory Type --') }}
                                                </button>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownStorage">
                                                    <li>
                                                    ...
                                                    <div id="memory-list">
                                                        @forelse ($memoryType as $item)
                                                            <li><a class="dropdown-item" href="#" name="memory_type" data-value="{{ $item->id }}">{{ $item->nama }}</a></li>
                                                        @empty
                                                            <li class="no-data"><a class="dropdown-item" href="#">Tidak Ada Data</a></li>
                                                        @endforelse
                                                    </div>
                                            ...
                                            <input type="hidden" id="selected-memory" name="memory_type" value="{{ old('memory_type', $device->memory_type) }}">
                                            ...
                                            <div class="dropdown mb-3">
                                                ...
                                                <button class="btn text-start dropdown-toggle" type="button" id="dropdownVGA" data-bs-toggle="dropdown" aria-expanded="false">
                                                    {{ old('vga_type') ? $VGAType->where('id', old('vga_type'))->first()->nama ?? '-- Pilih VGA Type --' : 
                                                    ($device->vgaType ? $device->vgaType->nama : '-- Pilih VGA Type --') }}
                                                </button>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownVGA">
                                                    ...
                                                    <div id="vga-list">
                                                        @forelse ($VGAType as $item)
                                                            <li><a class="dropdown-item" href="#" name="vga_type" data-value="{{ $item->id }}">{{ $item->nama }}</a></li>
                                                        @empty
                                                            <li class="no-data"><a class="dropdown-item" href="#">Tidak Ada Data</a></li>
                                                        @endforelse
                                                    </div>
                                            ...
                                            <input type="hidden" id="selected-vga" name="vga_type" value="{{ old('vga_type', $device->vga_type) }}">
                                        </div>
                                        ...
                                        <div class="col col-6">
                                            ...
                                            <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="serial_number" id="serial_number" value="{{old('serial_number', $device->serial_number)}}" placeholder="Masukkan Serial Number" class="form-control" required>
                                                    @error('serial_number')
                                                        <div class="alert alert-danger">{{$message}}</div>
                                                    @enderror
                                            </div>
                    ...
                    <div class=" col col-6">
                        ...
                        <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="dropdown mb-3">
                                                ...
                                                <button class="btn text-start dropdown-toggle" type="button" id="dropdownOS" data-bs-toggle="dropdown" aria-expanded="false">
                                                    {{ old('operation_system') ? $osType->where('id', old('operation_system'))->first()->nama ?? '-- Pilih Operation System --' : 
                                                    ($device->operationSystem ? $device->operationSystem->nama : '-- Pilih Operation System --') }}
                                                </button>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownOS">
                                                    ...
                                                    <div id="os-list">
                                                        @forelse ($osType as $item)
                                                            <li>
                                                                <a class="dropdown-item" href="#" name="operation_system" data-value="{{ $item->id }}">{{ $item->nama }}</a>
                                                            </li>
                                                        @empty
                                                            <li class="no-data"><a class="dropdown-item" href="#">Tidak Ada Data</a></li>
                                                        @endforelse
                                            ...
                                            <input type="hidden" id="selected-os" name="operation_system" value="{{ old('operation_system', $device->operation_system) }}">
                                            ...
                                            <button class="btn text-start dropdown-toggle" type="button" id="dropdownOffice" data-bs-toggle="dropdown" aria-expanded="false">
                                                {{ old('office') ? $officeType->where('id', old('office'))->first()->nama ?? '-- Pilih Office Type --' : 
                                                ($device->officeType ? $device->officeType->nama : '-- Pilih Office Type --') }}
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownOffice">
                                                ...
                                                <div id="office-list">
                                                    @forelse ($officeType as $item)
                                                        <li>
                                                            <a class="dropdown-item" href="#" name="office" data-value="{{ $item->id }}">{{ $item->nama }}</a>
                                                        </li>
                                                    @empty
                                                        <li class="no-data"><a class="dropdown-item" href="#">Tidak Ada Data</a></li>
                                                    @endforelse
                                        ...
                                        <input type="hidden" id="selected-office" name="office" value="{{ old('office', $device->office) }}">   
                                    <!-- Kolom Kedua -->
                                    </div>
                                        <div class="col col-6">
                                                <!-- OS license -->
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="os_license" class="form-control" required>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="office_license" class="form-control" required>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="aplikasi_lainnya" id="apk_lain" value="{{old('aplikasi_lainnya', $device->aplikasi_lainnya)}}" placeholder="Aplikasi Lainnya" class="form-control" required>
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <textarea class="col-lg-12" name="keterangan_tambahan" placeholder="Keterangan Tambahan" style="height:100px;" required>{{ old('keterangan_tambahan', $device->keterangan_tambahan) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-3">
                            <div class="form-group mb-3">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-gray text-center" required>Kondisi Perangkat Komputer</h6>
                                </div>
                                <div class="card-body">
