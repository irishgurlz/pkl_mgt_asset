<!-- Modal -->
<div class="modal fade" id="modal-add-jabatan"  aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg d-flex justify-content-center">
        <div class="modal-content" style="background-color: #ffff; border-radius: 15px; width: 60%;">
            ...
            <div class="modal-body">
                <form id="form-add-jabatan" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-2 d-flex justify-content-between">
                        <div class="me-3">Nama Jabatan</div>
                ...
                let newRow = `
                    <tr>
                        ...
                        <td class="d-flex justify-content-center">
                            <div class="me-2">
                                <a class="btn btn-warning" href="/jabatan/${data.id}/edit">Edit</a>
                            </div>
                            <form action="/jabatan/${data.id}" method="POST" onsubmit="return confirm('Are you sure you want to delete this jabatan?');" style="padding: 0; margin: 0;">
                                @csrf
                                @method('DELETE')
