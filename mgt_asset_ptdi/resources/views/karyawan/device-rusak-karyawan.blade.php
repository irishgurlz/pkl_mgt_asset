...
<body class="index-page light-background">
    ...
    <div class="container" data-aos="fade-up">
        <div class ="section-title mt-3" data-aos="fade-up" >
            <h2>Ajukan Kerusakan Perangkat Komputer</h2>
        </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('updateRusak', $disDetail->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nomor_it" class="form-control" value="{{ $disDetail->nomor_it }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="kategori" class="form-label">Kategori</label>
                            <input type="text" id="kategori" class="form-control" value="{{ $disDetail->device->kategori->nama }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="sub_kategori" class="form-label">Tipe Perangkat</label>
                            <input type="text" id="sub_kategori" class="form-control" value="{{ $disDetail->device->subKategori->nama }}" disabled>
                        </div>
