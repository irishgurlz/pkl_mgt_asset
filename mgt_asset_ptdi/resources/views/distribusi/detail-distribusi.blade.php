                        ...
                        <form id="searchForm" method="GET" action="{{ route('distribusi.index') }}">
                            <div class="mb-3 d-flex justify-content-between">
                                <div class="input-group me-2">
                                    <input type="text" class="form-control" id="search" name="search" placeholder="Search Detail Asset" value="{{ request('search') }}">
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="tableData" width="100%" cellspacing="0" style="table-layout: auto;">
                                    ...
                                    @include('distribusi.table-detail-distribusi')
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchInput.addEventListener('keyup', function(event) {
            ...
            fetch("{{ 'detailAsset'}}?search=" + searchQuery, {
                method: 'GET',
                headers: {
                    'Accept': 'text/html',
