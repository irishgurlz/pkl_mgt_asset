<form action="/distribution-asset/create/{{$dist->id}}" id="form-add-asset" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col col-3">
            <div class="mb-2">
                ...
                <input type="text" class="form-control" name="nomor_penyerahan" id="nomor_penyerahan_hidden" 
                    value="{{$dist->nomor_penyerahan}}" style="background-color: #f2f2f2;" readonly>
...
$(document).on('keyup blur', 'input[name="nomor_asset[]"]', function () {
    ...
    // Cek apakah nomor asset sudah digunakan dalam form ini
