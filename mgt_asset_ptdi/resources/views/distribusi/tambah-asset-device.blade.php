<form action="/distribution-asset/create/{{$dist->id}}" id="form-add-device" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col col-3">
            <div class="mb-2">
                ...
                {{-- @dd($item) --}}
                <input type="text" class="form-control" name="nomor_penyerahan" id="nomor_penyerahan_hidden" value="{{ $dist->nomor_penyerahan }}" style="background-color: #f2f2f2;" readonly>
...
$(document).on('input', 'input[name="nomor_it[]"]', function() {
    ...
    if (nomor_it) {
        $.ajax({
            ...
            error: function(xhr) {
                // nomorItStatus.text('Terjadi kesalahan, coba lagi nanti').removeClass('text-success').addClass('text-danger');
            }
        });
    } else {
        nomorItStatus.text('');
